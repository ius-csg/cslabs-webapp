...
export default class SitePolicy extends Component {
  render() {
    return (
      <Fragment >
        <Layout>
          ...
          <Accordion>
            <Card>
              <Accordion.Button as={Card.Header} eventKey='termsOfUse' className={styles['accordion-toggle-header']}>
                <h4> TERMS OF USE </h4>
              </Accordion.Button>
            ...
            <Card>
              <Accordion.Button as={Card.Header} eventKey='dispute' className={styles['accordion-toggle-header']}>
            ...
            <Card>
              <Accordion.Button as={Card.Header} eventKey='privacyPolicy' className={styles['accordion-toggle-header']}>
            ...
            <Card>
              <Accordion.Button as={Card.Header} eventKey='cookiePolicy' className={styles['accordion-toggle-header']}>
               <h4> COOKIE POLICY </h4>
              </Accordion.Button>
            ...
            <Card>
              <Accordion.Button as={Card.Header} eventKey='disclaimer' className={styles['accordion-toggle-header']}>
              <h4> DISCLAIMER </h4>
              </Accordion.Button>
