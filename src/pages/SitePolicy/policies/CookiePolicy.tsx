...
export const CookiePolicy = (props: {}) => (
  <div>
    ...
    This Cookie Policy explains how __________ ("Company", "we", "us", and "our") uses cookies and similar technologies to recognize you when you visit our websites at https://iuscsg.dev, ("Websites"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.
    ...
    .google.com
    Service:
    Google View Service Privacy Policy
    Country:
    United States
    Type:
    http_cookie
