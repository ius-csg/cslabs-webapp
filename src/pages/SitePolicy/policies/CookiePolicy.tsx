export const CookiePolicy = () => (
  <div>
    ...
    our websites at https://iuscsg.dev, https://iuscsg.com. <br/>
    ...
    <br/>
    Cookies set by the website owner (in this case, IUSCSG) are called "first party cookies".
    ...
    The parties that set these third party cookies can recognize your computer both when it visits the website
    ...
    Some cookies are required for technical reasons in order for our Websites to operate, and
    ...
    the purposes they perform are described below (please note that the specific cookies served may vary depending
    ...
    and areas of our website may be restricted. You may also set or amend your web browser controls to accept
    or refuse cookies. As the means by which you can refuse cookies through your web browser controls vary
    ...
    If you would like to find out more information, please visit http://www.aboutads.info/choices/
    ...
    _gid
    Purpose:
    Keeps an entry of unique ID which is then used to come up with statistical data on website usage by visitors.
    ...
    1 day
    */}<br/><br/>
    <h6> What about other tracking technologies, like web beacons? </h6>
    ...
    when someone has visited our Websites or opened an e-mail including them. This allows us, for example,
    to monitor the traffic patterns of users from one page within a website to another, to deliver or
    communicate with cookies, to understand whether you have come to the website from an online advertisement
    displayed on a third-party website, to improve site performance, and to measure the success of
    e-mail marketing campaigns. In many instances, these technologies are reliant on cookies to function properly,
    and so declining cookies will impair their functioning.
    <br/><br/>
    <h6>Do you use Flash cookies or Local Shared Objects?</h6>
    Websites may also use so-called "Flash Cookies" (also known as Local Shared Objects or "LSOs") to,
    among other things, collect and store information about your use of our services,
    ...
    and (for Flash Player 8 and later) how to block Flash Cookies that are not being delivered by the operator
    ...
    <br/><br/>
    <h6> Do you serve targeted advertising? </h6>
      ...
      or them to identify your name, contact details or
