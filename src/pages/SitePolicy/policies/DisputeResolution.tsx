export const DisputeResolution = () => (
  <div>
      ...
      <div>
        ...
        of the American Arbitration Association ("AAA") and, where appropriate,
        the AAA’s Supplementary Procedures for Consumer Related Disputes ("AAA Consumer Rules"),
        ...
        unless requested by either Party. The arbitrator must follow applicable law,
        ...
        the arbitration will take place in Floyd County, Indiana. Except as otherwise provided herein,
        ...
        the Dispute shall be commenced or prosecuted in the state and federal courts located in Floyd County,
        Indiana, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction,
      ...
      <div>
        ...
        class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported
        representative capacity on behalf of the general public or any other persons.
      </div>
      <br/><br/>
      <h6>Exceptions to Arbitration</h6>
      <div>
        ...
        allegations of theft, piracy, invasion of privacy, or unauthorized use; and (c) any claim for injunctive relief.
        If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate
        any Dispute falling within that portion of this provision found to be illegal or unenforceable and
        such Dispute shall be decided by a court of competent jurisdiction within the courts listed for
        jurisdiction above, and the Parties agree to submit to the personal jurisdiction of that court.
      ...
      <div>
        ...
        to correct any errors, inaccuracies, or omissions and to change or update the information on the Site at any time,
      ...
      <div>
        <b>
          ...
          OUR SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES,
          ...
          (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY
          ...
          ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SITE,
          ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING,
          AND WE WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND
          ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES. AS WITH THE PURCHASE OF A PRODUCT OR
      ...
      <div>
        <b>
          ...
          EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING ANYTHING
          TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND
          REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE AMOUNT PAID,
          IF ANY, BY YOU TO US. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR
          THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF
      ...
      <div>
        ...
        <ol>
          ...
          <li> any overt harmful act toward any other user of the Site with whom you connected via the Site.
      ...
      <br/><br/>
      <h6>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES </h6>
      <div>
        ...
        <b>
          ...
          or delivery or retention of non-electronic records, or to payments or the granting of credits
          by any means other than electronic means.
        </b>
      </div>
      <br/><br/>
      <h6> CALIFORNIA USERS AND RESIDENTS </h6>
      <div>
        ...
        in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or
      ...
      <div>
        ...
        in respect to the Site constitute the entire agreement and understanding between you and us.
        Our failure to exercise or enforce any right or provision of these Terms of Use shall not operate
        as a waiver of such right or provision. These Terms of Use operate to the fullest extent permissible by law.
