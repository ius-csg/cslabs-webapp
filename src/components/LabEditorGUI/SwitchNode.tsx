...
import {Node, Port} from 'beautiful-react-diagrams/@types/DiagramSchema';

const SwitchNode = ({id, inputs, outputs}: Omit<Node<any>, 'coordinates'>) => {
  ...
  function generatePorts(portType: Port[]): DetailedReactHTMLElement<any, any>[] {
    return (
